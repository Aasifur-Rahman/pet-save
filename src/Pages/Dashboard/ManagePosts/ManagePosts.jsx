...
const ManagePosts = () => {
  ...
  return (
    <div className="mt-14">
      <h1 className="text-3xl text-center mb-5">Foster Posts</h1>
      <div className="grid lg:grid-cols-1   justify-center gap-10 xl:max-w-screen-2xl md:max-w-screen-xl max-w-screen-lg  mx-auto">
